...
| P8-19 | DONE | 订阅升级引导 UI | P9 | 专业版功能、配额用尽、改编次数用尽弹窗分场景展示 |
...
| P9-08 | DONE | 团队版作品协作与统一账单 | P9-07,P2 | 项目协作者权限、按人/作品统计用量 |
| P9-09 | DONE | 体验额度与字数包 | P9-01,P9-03 | 免费一次性体验额度、月度配额、不过期字数包可叠加 |
